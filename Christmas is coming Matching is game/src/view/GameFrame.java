...
public class GameFrame extends JPanel  implements MouseListener, MouseMotionListener, WindowListener{
...
//To change body of generated methods, choose Tools | Templates.
    ...
    protected void paintComponent(Graphics g) {
        ...
        g2.drawString(Game.openImages + "", 170, 250);
        ...
        if(MyClock.status == false && Game.openImages < Integer.parseInt(savescore.getText())){
                 try (FileOutputStream fOut = new FileOutputStream("dataBot.dat");
                ObjectOutputStream oout = new ObjectOutputStream(fOut);) {
            oout.writeObject(Game.openImages+"");
