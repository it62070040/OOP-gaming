...
public class Vehicle extends JPanel  implements MouseListener, MouseMotionListener, WindowListener{

    private VehicleController view;
    public JFrame fr;
...
//        repaint();
    ...
    public void windowOpened(WindowEvent e) {
        ...
        File f = new File("dataBotVehicle.dat");
        if (f.exists()) {
            try (FileInputStream fin = new FileInputStream("dataBotVehicle.dat");
    ...
    protected void paintComponent(Graphics g) {
        ...
        g2.drawImage(highbut, 120, 50, 350, 250, null);
        g2.drawString(VehicleController.openImages + "", 260, 250);
        
        g2.setFont(new Font("Impact", Font.BOLD, 50));
        g2.drawImage(frameTimebut, 120, 300, 350, 250, null);
        g2.drawString(MyClock.clock + "", 170, 500);
        
        g2.drawImage(bestbut, 120, 550, 350, 250, null);
        g2.drawString(savescore.getText(), 260, 750);
        
        
        g2.drawImage(backbut, 200, 800, 180, 70, null);
        ...
        if (MyClock.status == false && VehicleController.openImages < Integer.parseInt(savescore.getText())) {
            try (FileOutputStream fOut = new FileOutputStream("dataBotVehicle.dat");
                    ObjectOutputStream oout = new ObjectOutputStream(fOut);) {
                oout.writeObject(VehicleController.openImages + "");
