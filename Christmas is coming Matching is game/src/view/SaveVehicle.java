...
public class SaveVehicle extends JPanel implements  Runnable {

    private JFrame fr;
    private JPanel p;
    private JLabel l;
    private VehicleController g;
    private int score;
    ...
    public SaveVehicle() {
        ...
        fr = new JFrame("END");
        g = new VehicleController();
        score = VehicleController.openImages;
        l = new JLabel(VehicleController.openImages+"");
        p = new JPanel();
...
//        g2.drawImage(highbut, 0, 100, 433, 241, null);
        g2.drawString(VehicleController.openImages + "", 810, 700);
