 ...
 * @author film
 */
public class CareerController extends JPanel {

    int numButtons;

    static String pics[] = {"/img/career/art2.png", "/img/career/chef2.png", "/img/career/doctor2.png", "/img/career/photo2.png",
                     "/img/career/fireman2.png", "/img/career/secure2.png"};
...
//            icons[j] = new ImageIcon(this.getClass().getResource(pics[i]));
            ...
            buttons[j].addActionListener(new CareerController.ImageButtonListener());
        ...
        myTimer = new Timer(1000, new CareerController.TimerListener());
    }
